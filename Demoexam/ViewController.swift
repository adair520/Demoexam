...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
       ...
       //01-UIView
        ...
        btn1.setTitle("01-UIView调试", for: UIControl.State())
        ...
        btn2.setTitle("02-UIViewController调试", for: UIControl.State())
        ...
        btn3.setTitle("03-UIScrollView", for: UIControl.State())
        ...
        btn4.setTitle("04-UITabbarController", for: UIControl.State())
        ...
        btn5.setTitle("05-UINavigationBar", for: UIControl.State())
        ...
        btn6.setTitle("06-Navigation+Tabbar", for: UIControl.State())
        ...
        btn7.setTitle("07-BasicControls", for: UIControl.State())
        ...
        btn8.setTitle("08-TableView", for: UIControl.State())
        ...
        btn9.setTitle("09-Collectionview", for: UIControl.State())
